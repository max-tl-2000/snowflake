 ...
 */
/*
dbt run --select customer_specific.maximus.custom_queries.AP_NoResponse --vars '{"target_schema": "SNOW_9F27B14E_6973_48A5_B746_434828265538"}'
*/

{{ config(alias='AP_NoResponse') }}
...
WHERE coalesce(per."email", '') <> ''
    AND p."closeReasonNonNull" IN ('FOUND_ANOTHER_PLACE', 'NOT_INTERESTED', 'NO_RESPONSE')
